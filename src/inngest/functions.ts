...
export const codeAgentFunction = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        const previousMessges = await step.run("get-previous-messages", async () => {
        ...
        const fragmentTitleGenerator = createAgent({
            ...
            description: "An fragment title generator",
        ...
        const responseGenerator = createAgent({
            ...
            description: "An response generator",
